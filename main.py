...
exp_dur = 2.1        #Experiment duration (seconds)
n_obs = 1         #number of observers (scanpaths) to simulate


# Model Parameters ---------------------------------------------------
k = 10                  #Cauchy distribution dispersion
threshold = 1.0         #Race Model threshold
noise = 7               #Race Model diffusion strength
...
# plot ----------------------------------------------------------------
sp_to_plot = 0          #idx of the simulated scanpath to plot
...
# Save to file (for remote/headless servers)
output_path = "simulation_result.png"
plt.savefig(output_path, dpi=150, bbox_inches='tight')
print(f"Saved to: {output_path}")

# Uncomment to show interactively (requires display)
# plt.show()
